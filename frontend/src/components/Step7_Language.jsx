...
const Step6_Language = ({ nextStep, prevStep, handleChange, values }) => {
  const continueStep = e => {
    e.preventDefault();
    nextStep();
  };

  // Array of languages based on your requirements
  const languages = [
  ...
  return (
    <div>
      ...
      <div className="form-group">
        <label htmlFor="language">Select the language for course generation:</label>
        <select
          id="language"
